...
class CalificacionCurso(models.Model):
    ...
    primer_examen = models.DecimalField(_('Primer Examen'), max_digits=6, decimal_places=2)
    segundo_examen = models.DecimalField(_('Segundo Examen'), max_digits=6, decimal_places=2)
    calificacion_final = models.DecimalField(_('Calificación Final'), max_digits=6, decimal_places=2)
    fecha_creacion = models.DateTimeField(_('Fecha de creación'), auto_now_add=True)
    fecha_actualizacion = models.DateTimeField(_('Fecha de actualización'), auto_now=True)
