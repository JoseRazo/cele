...
class EstudianteAdmin(DjangoUserAdmin, ImportExportModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Datos Generales'), {'fields': ('tipo_usuario', 'carrera', 'genero', 'preferencial', 'nombre', 'apellido_paterno', 'apellido_materno', 'email', 'telefono', 'avatar')}),
    ...
    list_filter = ('tipo_usuario', 'is_active', 'genero', 'preferencial')
